...
# ADD LINK32 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib ..\..\lib\mmfs2.lib /nologo /dll /machine:I386 /def:".\Ext.def" /out:".\Release_Small/Viewport.mfx"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
TargetPath=.\Release_Small\Viewport.mfx
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(TargetPath) .\ToInstall\Files\Extensions
# End Special Build Tool
...
# ADD LINK32 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib ..\..\lib\mmfs2.lib /nologo /dll /machine:I386 /def:".\Ext.def" /out:".\Run_Only_Small/Viewport.mfx"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
TargetPath=.\Run_Only_Small\Viewport.mfx
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(TargetPath) .\ToInstall\Files\Data\Runtime
# End Special Build Tool
